<?php
class pluginsandbox extends wv35v_action {
...
//				$diag ['application'] ['name'] = $this->application ()-> name;
//				$diag ['application'] ['version'] = $this->application ()-> version;
//				$diag ['application'] ['option_info'] = $this->application ()->options_name ( false );
...
//		$this->view->table_url = $this->control_url ( '/' . $this->application ()-> name . '/' );
