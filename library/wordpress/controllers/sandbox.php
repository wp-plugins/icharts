<?php
class sandbox extends wv35v_action {
	public function __construct(&$application) {
		parent::__construct ( $application );
	}
//	public function whapsandWPpage() {
//		$this->send_headers ( '.txt' );
//		//var_dump($this->data()->whap_button_templates);
//		//return;
//		echo 'here';
//		$src = get_current_blog_id ();
//		$this->mu ()->copy_post ( 'whap_2', 249 );
//	
//		//print_r($new_post_id);
//	}
//	public function sandboxWPpage() {
//		$this->send_headers ( '.txt' );
//		$this->legacy ()->move ();
//		echo 'here';
//		return;
...
//		$data ['current'] = 126;
//		$data ['type'] = 'subtopic';
//		$url = $this->control_url ( 'whap_addnew.json' );
...
//		return true;
//	}
//	public function sandbox2WPpage() {
		//$this->send_headers ( '.txt' );
		//$options = $this->data ()->options ();
		//var_dump ( $options );
//		echo "\n";
		//$old_options = $this->legacy_data ()->saved_data_locations ();
		//var_dump ( $old_options );
//		echo "\n";
//		var_dump ( $this->application ()->name );
//		echo "\n";
//	
		//var_dump ( $this->application ()->_config );
	//echo "\n";
	

	//print_r(WP_PLUGIN_DIR);
	//print_r(WP_PLUGIN_URL);
//	}
//	public function ajax_sandboxWPpage() {
//		$this->send_headers ( '.txt' );
//		$data = array ();
//		$data ['post_id'] = 7;
//		$data ['current'] = - 1;
//		$url = $this->control_url ( 'whap_settings.json' );
//		$http = new bv35v_http ( $url );
//		$http->data ( $data );
//		$http->method ( "POST" );
//		$page = $http->get ();
...
//		}
//	}
//	public function sandboxWPmenuMeta($return) {
//		$return ['menu'] = 'Sandbox';
...
//		$posts = get_users_drafts ( $user->ID );
//		foreach ( $posts as $post ) {
//			$post = get_post ( $post->ID );
//			$post->post_category = wp_get_post_categories ( $post->ID );
//			$this->Debug ( $post, wp_get_post_categories ( $post->ID ) );
//		}
//	}
...
//		}
//		$page .= "<br><b>Controlling library is: </b>" . $this->application ()->name;
//		return $content . $page;
//	}
...
//		$file = '/Volumes/angus-hd/Users/damianmanifold/Library/Application Support/Plex Media Server/Plug-in Support/Databases/com.plexapp.plugins.library.db';
//		//$file = '/Volumes/Users/com.plexapp.plugins.library.db';
//		$this->sqlite()->open($file);
//		$sql = "SELECT media_parts.file , media_items.library_section_id,metadata_item_id  FROM media_parts join media_items on media_parts.media_item_id = media_items.id join metadata_items on metadata_item_id = meta_data_items.id where file like '%shield%'";
//		$sql = "SELECT media_parts.file , media_items.library_section_id,metadata_items.title FROM media_parts join media_items on media_parts.media_item_id = media_items.id join metadata_items on metadata_items.id = media_items.metadata_item_id where media_items.library_section_id = 12";
//		$files = array ();
//		echo '<pre>';
//		var_dump($this->sqlite()->execute ( $sql ));
//		echo '<pre>';
//		return $content;
//	}
