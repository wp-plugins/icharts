<?php
if (! class_exists ( 'bv35v_application' )) :
	require dirname ( __FILE__ ) . '/base.php';
	class bv35v_application extends bv35v_base {
		...
		public function &sqlite() {
			return $this->cache ( 'bv35v_data_sqlite' );
		}
		public function &request() {
			return $this->cache ( 'bv35v_request' );
		}
		...
		public function __construct($filename) {
			...
			if (! class_exists ( 'bv35v_data_settings' )) {
				$dir = dirname ( $filename );
				require_once $dir . '/library/base/data/settings.php';
				$this->_config = bv35v_data_settings::config ( $filename );
			}
		...
		public function &loader() {
			return $this->cache ( 'bv35v_loader' );
		}
	}
